        ...
        <div className="w-full flex flex-col gap-4">
            ...
            <FadeInSection>
                <div className="w-full flex items-center justify-center gap-4 flex-col md:flex-row">
                    <Card className="flex-1 max-w-94 shadow-inner pb-0 group">
                        <div className="flex flex-col px-4 overflow-hidden">
                            ...
                            <div className="w-full relative h-46">
                                <Image src="paper-plane.svg" width={100} height={100} alt="feature illustration" className="rotate-[30deg] absolute top-[-30px] left-[30px] w-full max-w-63 group-hover:translate-x-11 group-hover:translate-y-4 transition-all duration-300 ease-in-out" />
                            </div>
                    ...
                    <Card className="flex-1 max-w-94 shadow-inner pb-0 group">
                        <div className="flex flex-col px-4 overflow-hidden">
                            ...
                            <div className="w-full relative h-46">
                                <Image src="analysis-presentation.svg" width={100} height={100} alt="feature illustration" className="absolute w-full group-hover:rotate-[-7deg] transition-all duration-300 ease-in-out" />
                            </div>
                        </div>
                    </Card>
                </div>
                ...
                <div className="w-full flex items-center justify-center gap-4 flex-col md:flex-row">
                    <Card className="flex-1 max-w-94 shadow-inner pb-0 group">
                        <div className="flex flex-col px-4 overflow-hidden">
                            ...
                            <div className="w-full relative h-46">
                                <Image src="happy-man-waving.svg" width={100} height={100} alt="feature illustration" className="absolute w-full group-hover:rotate-[-7deg] group-hover:-translate-y-6 transition-all duration-300 ease-in-out" />
                            </div>
                        </div>
                    </Card>
                    ...
                    <Card className="flex-1 max-w-94 shadow-inner pb-0 group">
                        <div className="flex flex-col px-4 overflow-hidden">
                            ...
                            <div className="w-full relative h-46">
                                <Image src="keynote_presentation.svg" width={100} height={100} alt="feature illustration" className="absolute w-full left-8 rotate-[-14deg] group-hover:-translate-y-6 group-hover:-translate-x-6 transition-all duration-300 ease-in-out" />
                            </div>
                        </div>
                    </Card>
                </div>
